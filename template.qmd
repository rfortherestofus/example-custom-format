---
title: Childhood Immunization Report
format:
  example-custom-format-typst: default
---
...
```{=typst}
#connected_boxes(text1: "text", text2: "another text")
```
...
```{=html}
<p style="font-style: italic; font-family: 'Bitter';">Source: ChildVaxView</p>
```
...
```{=typst}
#status-box(
   top-box-text: "Universal Purchaser?", 
   bottom-box-text: "No"
   )
```
